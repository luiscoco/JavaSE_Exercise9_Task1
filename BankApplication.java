...
public class BankApplication {
    public static void main(String[] args) {
        ...
        Client client1 = new Client("John Doe", 1000.0);
        Client client2 = new Client("Jane Smith", 5000.0);
        Client client3 = new Client("Alice Johnson", 2000.0);
    ...
    public static void printBalance(Bank bank) {
        ...
        for (Client client : clients) {
            Account account = client.getAccount();
            System.out.println(client.getName() + "'s account balance: $" + account.getBalance());
        }
    }
}
